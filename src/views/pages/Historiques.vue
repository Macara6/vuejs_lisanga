      ...
      <Card class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mt-6">
        <template #title>
          <h2 class="text-xl font-bold text-gray-700 dark:text-gray-100">
            📜 Historique des transactions depôt, retrait, envoie
          </h2>
        </template>
          ...
          <div v-else class="flex flex-col">
            ...
            <div class="flex flex-wrap gap-4 items-center mb-4">
              ...
              <div>
                ...
                <input type="text" v-model="filterReference" placeholder="Ex: REF12345" class="border rounded px-2 py-1"/>
              </div>

              <div class="flex gap-2 items-end">
                <Button label="Réinitialiser" icon="pi pi-refresh" severity="secondary" @click="resetFilters" />
                <Button label="Télécharger PDF" icon="pi pi-file-pdf" class="p-button-danger" @click="downloadPDF" />
              </div>
            </div>
