  ...
  <div class="w-full md:w-3/4 lg:w-2/3">
    <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl">
      <div class="text-center mb-8">
        <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-100">💰 Retrait Épargne</h2>
        <p class="text-gray-500 dark:text-gray-400 mt-2">Visualisez le compte avant de retirer</p>
      </div>
     ...
     <div v-if="step === 1" class="space-y-4">
        ...
        <div class="flex justify-between mt-6">
          ...
          <Button label="Valider" icon="pi pi-check" class="p-button-success p-button-rounded" @click="submitWithdraw" :loading="loading" />
        </div>
      </div>
        ...
        <div class="flex justify-start mt-4">
          <Button label="Nouveau retrait" icon="pi pi-refresh" outlined @click="newWithdraw" />
        </div>
      </div>
